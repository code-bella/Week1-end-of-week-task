...
class EndOfWeek1TaskTest {
    ...
    void tooShortShouldGiveAnError() {
        assertEquals("Error, password too short.", EndOfWeek1Task.pwdChecker("te8T", 5));
    }
    ...
    void noLowercaseLetterShouldGiveAnError() {
        assertEquals("Error, password must contain a lowercase letter.", EndOfWeek1Task.pwdChecker("6789278389890", 5));
    }
